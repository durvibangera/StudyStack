...
export async function GET() {
  ...
  // We MUST request openid and profile to get the user's URN (required for posting).
  // This requires the "Sign In with LinkedIn using OpenID Connect" product to be active.
