...
export async function POST(request: Request) {
  try {
    ...
    const systemPrompt = `You are a highly experienced Education Counselling Strategist at StudyStack with expertise in creating comprehensive student outreach and counselling campaigns for overseas education.
...
2. "rationale": A detailed strategic analysis in HTML format that includes:
   ...
   - Core Strategic Concept (the big idea that connects StudyStack's offerings to student aspirations)
