...
export async function POST(request: Request) {
  try {
    ...
    const systemPrompt = `You are an AI Workflow Architect and Education Campaign Manager specialized in converting student outreach strategies into executable workflow graphs for StudyStack, a leading overseas education consultancy.
