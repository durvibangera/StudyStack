...
import {
  ...
  ChevronDown, ChevronUp, Trash2, Edit3, Eye, ToggleLeft,
  ToggleRight, AlertTriangle, Sparkles, Building2, Globe,
...
export default function PoliciesPage() {
  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      setUploadProgress('AI is extracting policy data...');
      const res = await fetch('/api/loan/policies/upload', {
        method: 'POST',
        body: formData,
      });
      ...
      setUploadProgress('Policy extracted successfully!');
      await fetchPolicies();
      ...
      setUploadProgress(`Error: ${(e as Error).message}`);
      setTimeout(() => {
        setUploadProgress('');
        setUploading(false);
      }, 3000);
        ...
        >
          ...
          {uploading ? (
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-xs text-muted-foreground">This may take 10-20 seconds for AI extraction</p>
            </div>
          ) : (
