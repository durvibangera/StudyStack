          ...
          <div className="order-2 flex flex-col items-start md:order-1">
            <div className="mb-4 sm:mb-6 flex items-center gap-4">
              ...
              <div className="leading-tight">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-slate-900 dark:text-white">StudyStack</div>
                <div className="text-sm sm:text-base text-slate-500 dark:text-slate-400">AI-Native Student Engagement Platform</div>
              </div>
            </div>
            ...
            <p className="mb-6 sm:mb-8 max-w-xl text-base sm:text-lg leading-relaxed text-slate-700 dark:text-slate-300">
              Automate student counselling with conversational AI, extract structured data from natural conversations, qualify leads intelligently, and generate actionable reports. Built for StudyStack.
            </p>
            ...
            <div className="absolute -bottom-4 -left-4 sm:bottom-12 sm:left-4 z-20 animate-float-delayed">
              <div className="flex items-center gap-3 bg-linear-to-r from-blue-500/90 to-cyan-500/90 backdrop-blur-md rounded-full px-4 py-3 shadow-xl border border-blue-400/30">
                ...
                <div className="text-left">
                  ...
                  <p className="text-white/80 text-xs ivy-font">Students Engaged</p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              AI voice agents, lead qualification scoring, structured data extraction, and automated follow-up workflows for student engagement & education financing
            </p>
          </div>
